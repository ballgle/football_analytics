...
function pixel() {
    ...
    if (!ic_cat) { ic_cat = ""; }
    if (!ic_type) { ic_type = ""; }
    if (locHttp.toLowerCase() == "https") { prefix = "https://web.archive.org/web/20120823182810/https://www" + icstring + ""; }
    if (locHttp.toLowerCase() == "http") { prefix = "https://web.archive.org/web/20120823182810/http://1554" + icstring + ""; }
...
/*
     FILE ARCHIVED ON 18:28:10 Aug 23, 2012 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  captures_list: 211.541
  PetaboxLoader3.resolve: 70.042 (2)
  exclusion.robots: 0.363
  esindex: 0.023
  PetaboxLoader3.datanode: 166.34 (4)
  load_resource: 168.303
  LoadShardBlock: 161.521 (3)
  CDXLines.iter: 36.185 (3)
  RedisCDXSource: 3.351
